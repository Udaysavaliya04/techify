...
<g clip-path="url(#clip0_1502_2791)">
...
<g clip-path="url(#clip0_1502_2802)">
...
<g clip-path="url(#clip0_1502_2820)">
...
<rect width="228" height="100" fill="white"/>
          ...
          case 'sap':
            return (
              <svg width="100" height="80" viewBox="0 0 205 100" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_1503_2796)">
<path fill-rule="evenodd" clip-rule="evenodd" d="M0 99.9931H102.15L202.118 0.00732422H0V99.9931Z" fill="url(#paint0_linear_1503_2796)"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M119.946 20.0043H99.9843L100.051 66.9532L82.669 19.9887H65.4336L50.5957 59.2121C49.0182 49.2313 38.6997 45.7873 30.5808 43.2077C25.2193 41.4857 19.529 38.9527 19.5868 36.1531C19.6313 33.8557 22.6308 31.7249 28.5922 32.0426C32.5916 32.2581 36.1245 32.5803 43.1524 35.9754L50.0625 23.9326C43.6545 20.6709 34.7935 18.6112 27.5279 18.6045H27.4835C19.0113 18.6045 11.9568 21.3485 7.58408 25.8701C4.53562 29.0252 2.89141 33.038 2.82476 37.4751C2.71366 43.5809 4.95112 47.9092 9.65267 51.3687C13.6254 54.2794 18.7069 56.168 23.1841 57.5545C28.7055 59.2654 33.216 60.7541 33.1604 63.9225C33.1234 65.0845 32.6562 66.1915 31.8495 67.0287C30.4719 68.4507 28.3611 68.984 25.4393 69.0418C19.8023 69.1618 15.6252 68.2752 8.96833 64.3402L2.82031 76.5385C9.47048 80.3202 16.5295 82.2177 24.5506 82.2177L26.3547 82.2043C33.336 82.0777 39.0018 80.4046 43.5034 76.7829C43.7612 76.5763 43.9922 76.3674 44.2322 76.1563L43.4768 80.0491L60.3188 79.9958L63.3406 72.2591C66.5179 73.3434 70.1307 73.9433 73.9658 73.9433C77.703 73.9433 81.2181 73.3745 84.3354 72.3524L86.4418 79.9958L116.66 80.0247L116.733 62.3872H123.163C138.705 62.3872 147.893 54.4772 147.893 41.2124C147.889 26.4389 138.957 20.0043 119.946 20.0043ZM73.9658 60.1364C71.7918 60.1512 69.633 59.7733 67.5933 59.021L73.8947 39.1238H74.0169L80.216 59.0765C78.3496 59.7431 76.2254 60.1364 73.9658 60.1364ZM121.115 48.7047H116.729V32.6692H121.117C126.96 32.6692 131.626 34.6155 131.626 40.5836C131.622 46.7605 126.96 48.7047 121.117 48.7047" fill="white"/>
</g>
<defs>
<linearGradient id="paint0_linear_1503_2796" x1="101.059" y1="0.00732422" x2="101.059" y2="99.9953" gradientUnits="userSpaceOnUse">
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  ...
                  padding: window.innerWidth <= 768 ? "0.85rem 0.3rem" : "1rem 0.5rem",
                  overflow: "hidden",
                  marginBottom: "1rem",
                }}
              >
                <motion.div
                  ...
                  style={{
                    display: "flex",
                    alignItems: "center",
                    gap: window.innerWidth <= 768 ? "0.75rem" : "0.95rem",
                    width: "max-content",
                    WebkitMaskImage:
                      window.innerWidth <= 768
                ...
                >
                  {[...featuredCompanyLogos, ...featuredCompanyLogos].map((company, index) => (
                    <div
                      ...
                      style={{
                        minWidth: window.innerWidth <= 768 ? "170px" : "188px",
                        height: window.innerWidth <= 768 ? "76px" : "88px",
                        borderRadius: "16px",
                        border: "none",
                        background: "rgba(255, 255, 255, 0.05)",
                        display: "flex",
                    ...
                    >
                      <div
                        style={{
                          transform: window.innerWidth <= 768 ? "scale(1.18)" : "scale(1.28)",
